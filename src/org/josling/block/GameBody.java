...
public class GameBody extends JPanel implements Runnable {
    ...
    private BlockPanel brickPanel;
    private BlockFrame brickFrame;

    public int getGameStatus() {
        return gameStatus;
    }

    public GameBody(BlockPanel brickPanel) {
    ...
    public void run() {
        while (true) {
            ...
            synchronized (this) {
                while (gameStatus == GAME_PAUSE || gameStatus == GAME_WAIT_ANIMATION) {
                    try {
                        this.wait();
